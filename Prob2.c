//Escribir un algoritmo que lea 10 calificaciones el cual debe ser
//almacenado en un arreglo. Luego recorra el arreglo por medio de 
//un ciclo repetitivo para obtener la suma. 
//Finalmente, imprimir el promedio de las calificaciones.
